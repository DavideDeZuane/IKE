...
\lstset{
    ...
    morekeywords=[1]{pki, ipsec, ip, xfrm, conn, EAP, RSA, ECDSA, openssl}, 
...
rispetto alla versione precedente è la possibilità di autenticazione tramite certificati. I file e le directory interessate dalla configurazione sono le seguenti.
\\
